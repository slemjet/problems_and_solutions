...
class TrappingRainWaterTest {
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    void testTrapDpBottomUp(int[] nums, int expected) {
        // given
        TrappingRainWater solution = new TrappingRainWater();

        // when
        int result = solution.trapDpBottomUp(nums);
    ...
    @ParameterizedTest
    @MethodSource("parameters")
    void testTrapStack(int[] nums, int expected) {
        // given
        TrappingRainWater solution = new TrappingRainWater();

        // when
        int result = solution.trapStack(nums);
